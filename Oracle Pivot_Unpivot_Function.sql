...
/*
L_SEQ_NO       PAN ACCTTYPE TAXYEAR PERIOD OFFCODE      MA_NO FILEPER MAAMOUNT INTAMOUNT PENAMOUNT ADDAMOUNT
-------- --------- -------- ------- ------ ------- ---------- ------- -------- --------- --------- ---------
       1 100343122        0    2072      2    2504 7203153946 M           8268      1222      8267         0
*/
...
;
/*
L_SEQ_NO PAN       ACCTTYPE TAXYEAR PERIOD OFFCODE      MA_NO FILEPER MAAMOUNT
-------- --------- -------- ------- ------ ------- ---------- ------- --------
       1 100343122        0    2072      2    2504 7203153946 M           8268
       1 100343122        0    2072      2    2504 7203153946 M           1222
       1 100343122        0    2072      2    2504 7203153946 M           8267
       1 100343122        0    2072      2    2504 7203153946 M              0
*/
----------------
 WITH test
AS
...
L_SEQ_NO PAN       ACCTTYPE TAXYEAR PERIOD OFFCODE      MA_NO FILEPER MAAMOUNT INTAMOUNT PENAMOUNT ADDAMOUNT
-------- --------- -------- ------- ------ ------- ---------- ------- -------- --------- --------- ---------
       1 100343122 00          2072      2    2504 7203153946 M           8268         0      8268         0
*/
...
FROM (
     ...
     UNPIVOT INCLUDE NULLS
     (
      (maamount, intamount, penamount, addamount)
       FOR fileper IN
         (
          (maamount, intamount, penamount, addamount)       as 'M',
          (maamount, intamount, penamount, addamount)       as 'T',
          (maamount, intamount, penamount, addamount)       as 'B'
         )
      )
WHERE pan ='100343122'
ORDER BY 2,8 ;
...
L_SEQ_NO PAN       ACCTTYPE TAXYEAR PERIOD OFFCODE      MA_NO FILEPER MAAMOUNT INTAMOUNT PENAMOUNT ADDAMOUNT
-------- --------- -------- ------- ------ ------- ---------- ------- -------- --------- --------- ---------
       1 100343122 00          2072      2    2504 7203153946 B           8268         0      8268         0
       1 100343122 00          2072      2    2504 7203153946 M           8268         0      8268         0
       1 100343122 00          2072      2    2504 7203153946 T           8268         0      8268         0
*/
