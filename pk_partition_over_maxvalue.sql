              ...
              BEGIN
                   IF (l_flag <> '~') THEN
                      ...
                      LOOP
                         ...
                         EXIT WHEN l_curr%NOTFOUND;
                           BEGIN
                              EXECUTE IMMEDIATE 'ALTER TABLE '||l_table_owner||'.'||l_table_name||' SPLIT PARTITION '||l_old_partition_name||' AT ('||l_new_partition_value||')
                                                 INTO
                                                 (
                      ...
                      ELSE
                         ...
                         BEGIN
                             ...
                             EXECUTE IMMEDIATE (l_sql) INTO l_table_owner,l_table_name,l_new_partition_name;
                             BEGIN
                                 EXECUTE IMMEDIATE 'ALTER TABLE '||l_table_owner||'.'||l_table_name||' RENAME PARTITION '||l_old_partition_name||' TO '||l_new_partition_name;
